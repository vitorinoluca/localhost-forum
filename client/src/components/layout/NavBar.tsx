...
function Badge({ count }: { count: number }) {
  ...
  return (
    <span className='absolute -right-1 -top-1 flex min-h-[16px] min-w-[16px] items-center justify-center rounded-full bg-[#3b82f6] px-1 text-[9px] font-bold leading-none text-white'>
      {label}
    </span>
  );
}
